...
void mine_init_bmp(){
	...
	//number 0  to 8
	mine_bmp_num[0] = load_bmp("./mine/num_0.bmp");
	mine_bmp_num[1] = load_bmp("./mine/num_1.bmp");
	mine_bmp_num[2] = load_bmp("./mine/num_2.bmp");
	mine_bmp_num[3] = load_bmp("./mine/num_3.bmp");
	mine_bmp_num[4] = load_bmp("./mine/num_4.bmp");
	mine_bmp_num[5] = load_bmp("./mine/num_5.bmp");
	mine_bmp_num[6] = load_bmp("./mine/num_6.bmp");
	mine_bmp_num[7] = load_bmp("./mine/num_7.bmp");
	mine_bmp_num[8] = load_bmp("./mine/num_8.bmp");		//8

	//state
	mine_bmp_sta[0] = load_bmp("./mine/sta_blank.bmp");//9
	mine_bmp_sta[1] = load_bmp("./mine/sta_flag.bmp");		//10
	mine_bmp_sta[2] = load_bmp("./mine/sta_unknown.bmp");		//11

	//bomb
	mine_bmp_bomb[0] = load_bmp("./mine/bomb_nat.bmp");		//12
	mine_bmp_bomb[1] = load_bmp("./mine/bomb_focused.bmp");	//13

	//tool
	//face
	mine_bmp_tool[MINE_BMP_TOOL_SMILE] = load_bmp("./mine/tool_smile.bmp");
	mine_bmp_tool[MINE_BMP_TOOL_CRY] = load_bmp("./mine/tool_cry.bmp");
	mine_bmp_tool[MINE_BMP_TOOL_SUCCESS] = load_bmp("./mine/tool_success.bmp");
	mine_bmp_tool[MINE_BMP_TOOL_FLAG] = load_bmp("./mine/tool_flag.bmp");
	mine_bmp_tool[MINE_BMP_TOOL_UKN] = load_bmp("./mine/tool_unknown.bmp");
	mine_bmp_tool[MINE_BMP_TOOL_CUR] = load_bmp("./mine/tool_cursor.bmp");
}
